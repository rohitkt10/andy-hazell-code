...
The results of the previous section can be adapted for the case where $W_r=I$. 

We note again that:
% 
\begin{equation}
\nrm{T_{\tiny{\ma{r\\w}}\rightarrow z}}^2_2 =
...
\als{
\nrm{T_{r\rightarrow z}}^2_2=\tra{\underbrace{B_{1gr}'X_{gg}B_{1gr}+D_{11gr}'D_{11gr}-F_{2p0}'\bar{R}F_{2p0}}_{\mbox{No preview}}-\underbrace{\sum_{j=0}^{N-1}S' A^j_{cg} B_{2g}{\bar R}^{-1} B_{2g}'{A^j_{cg}}'S}_{\mbox{Preview reduction}}}.
}
